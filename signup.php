            ...
            <div class="row flex-wrap align-items-center justify-content-center">
                ...
                <div class="col-lg-8 col-12">
                    <div class=" my-3 text-center">
                        <input placeholder="Email..." class="input d-block mx-auto w-100" name="email" type="email" value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>">
                ...
                <div class="col-lg-8 col-12">
                    <div class=" my-3 text-center">
                        <input placeholder="Username..." class="input d-block mx-auto w-100" name="username" type="text" value="<?= isset($_POST['username']) ? $_POST['username'] : '' ?>">
                ...
                <div class="col-lg-8 col-12">
                    ...
                    <div class=" my-3 text-center">
                        <input placeholder="Password..." class="input d-block mx-auto w-100" name="password" type="password" value="<?= isset($_POST['password']) ? $_POST['password'] : '' ?>">
