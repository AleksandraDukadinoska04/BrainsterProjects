...
<div class="container">
    ...
    <div class="head mx-auto mb-2">
        ...
        <h1 class="text-secondary text-end fst-italic m-0 mt-auto w-75">Create Event Speaker</h1>
    </div>
    <hr>

    <form id="eventSpeaker-form" method="POST" class="form-column d-flex align-itemns-start justify-content-between flex-wrap mx-auto">
        @csrf
        ...
        <div class="coolinput">
            ...
            <select name="speaker_id" id="speaker_id" class="input">
                ...
                <option value="{{ $speaker->id }}" {{ $speaker->id === old('speaker_id') ? 'selected' : ''}}>{{ $speaker->name }} {{ $speaker->surname }}</option>
                @endforeach
            </select>
        ...
        <div class="coolinput">
            ...
            <select name="speaker_type" id="speaker_type" class="input">
                ...
                <option value="ordinary" {{ 'ordinary' === old('speaker_type') ? 'selected' : ''}}>Ordinary</option>
                <option value="special" {{ 'special' === old('speaker_type') ? 'selected' : ''}}>Special</option>
            </select>
        ...
        <div class="coolinput">
            ...
            <textarea name="speaker_invitation" class="input" id="speaker_invitation" placeholder="Write speaker invitation...">{{old('speaker_invitation')}}</textarea>
